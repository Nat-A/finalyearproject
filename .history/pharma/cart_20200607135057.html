...
<head>
    <title>PharmaLyn &mdash; Cart</title>
    <meta charset="utf-8">
                    ...
                    <div class="main-nav d-none d-lg-block">
                        <nav class="site-navigation text-right text-md-center" role="navigation">
                            <ul class="site-menu js-clone-nav d-none d-lg-block">
                                ...
                                <!-- the user at this point is logged in -->
                            </ul>
                        </nav>
                    </div>
                    <div class="icons">
                ...
                <div class="row mb-5">
                    <form class="col-md-12" method="post">
                        <div class="site-blocks-table">
                            ...
                            <!-- the site fetches the name and other relevant details of the product and updates the cart -->
                                ...
                                <tbody>
                                    <tr>
                                        <td class="product-thumbnail">
                                            <img src="images/products/product_02.png" alt="Image" class="img-fluid">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="product-thumbnail">
                                            <img src="images/products/product_01.png" alt="Image" class="img-fluid">
                                        </td>
                                        <td class="product-name">
                    ...
                    <div class="col-md-6">
                        <div class="row mb-5">
                            <div class="col-md-6 mb-3 mb-md-0">
                                <!-- cart update occurs here -->
                                <button class="btn btn-primary btn-md btn-block">Update Cart</button>
                            </div>
                            <div class="col-md-6">
                                <!-- use cart updates and redirects the user to the store after update -->
