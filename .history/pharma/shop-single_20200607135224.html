...
<head>
    <title>PharmaLyn &mdash; Store Item</title>
    <meta charset="utf-8">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 mb-0"><a href="index.php">Home</a> <span class="mx-2 mb-0">/</span>
                        <!-- the name of the drug you click on appears here and changes per the drug-->
                        <a href="shop.php">Store</a> <span class="mx-2 mb-0">/</span>
                        <strong class="text-black">Ibuprofen Tablets, 200mg</strong></div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-5 mr-auto">
                        <div class="border text-center">
                            <img src="images/products/product_07_large.png" alt="Image" class="img-fluid p-5">
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <p> <strong class="text-primary h4">$55.00</strong></p>
