...
<head>
    <title>PharmaLyn &mdash; Contact Us</title>
    <meta charset="utf-8">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="p-4 bg-white mb-3 rounded">
                            <span class="d-block text-black h6 text-uppercase">Accra</span>
                            <p class="mb-0">233 Avenue, Oxford Street, Osu, Accra.</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="p-4 bg-white mb-3 rounded">
                            <span class="d-block text-black h6 text-uppercase">Cape Coast</span>
                            <p class="mb-0">23 Kwesi Plange Lane, UCC, Cape Coast.</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="p-4 bg-white mb-3 rounded">
                            <span class="d-block text-black h6 text-uppercase">Kumasi</span>
                            <p class="mb-0">West 57th , Manhyia, Kumasi.</p>
                        </div>
                    </div>
                </div>
            </div>
